...
public sealed record ProcessRule
{
    ...
    public CpuAffinityMode AffinityMode { get; init; } = CpuAffinityMode.None;

    /// <summary>Only used when <see cref="AffinityMode"/> is CustomMask.</summary>
    public ulong? CustomAffinityMask { get; init; }
    ...
    public IoPriorityLevel? IoPriority { get; init; }

    public MemoryPriorityLevel? MemoryPriority { get; init; }
